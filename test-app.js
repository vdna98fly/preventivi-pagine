...
assert.match(html, /id="p-fornitore-nome"[^>]*list="p-fornitori-salvati"/);
assert.match(html, /<datalist id="p-fornitori-salvati">/);
...
assert.ok(run("document.querySelector('#p-fornitori-salvati').innerHTML.toLowerCase()").includes('ideal standard'));
run("document.querySelector('#p-fornitore-email').value=''; applicaFornitoreMemorizzato('ideal standard')");
